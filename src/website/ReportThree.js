...
function ReportThree() {
  ...
  useEffect(() => {
    ...
    async function getReport() {
        const {data: reportData} = await supabase.rpc('getreportthree')
                ...
                <TableBody>
                  {report.map((dato) => (
                    ...
                    >
                      ...
                      <TableCell align="center">{dato.peso}</TableCell>
                      <TableCell align="center">{dato.altura}</TableCell>
                      <TableCell align="center">{dato.imc}</TableCell>
                    </TableRow>
                  ))}
              </TableBody>
